...
# -*- coding: utf-8 -*-
#
# jupyter_template documentation build configuration file, created by
...
htmlhelp_basename = "jupyter_templatedoc"
...
latex_documents = [
    (master_doc, "jupyter_template.tex", "jupyter_template Documentation",
     "Tim Paine", "manual"),
]
...
man_pages = [
    (master_doc, "jupyter_template", "jupyter_template Documentation",
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, "jupyter_template", "jupyter_template Documentation",
     author, "jupyter_template", "A Python/JS project template for Jupyter extensions",
     "Miscellaneous"),
]
...
def run_apidoc(_):
    ...
    _dir = os.path.abspath(os.path.join(os.path.dirname(__file__), "..", "jupyter_template"))
